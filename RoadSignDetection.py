...
roundabout_cascade = cv2.CascadeClassifier('D:\\Fall2016\\CS6600AI\\Projects\\haarcascade_roundabout.xml')
street = cv2.imread('D:\\Fall2016\\CS6600AI\\Projects\\roundabout3.png')
#street = cv2.imread('D:\\Fall2016\\CS6600AI\\Projects\\U_turn.jpg')
 
# do roundabout detection on street image
gray = cv2.cvtColor(street,cv2.COLOR_RGB2GRAY)
roundabouts = roundabout_cascade.detectMultiScale(gray, scaleFactor=1.4, minNeighbors=3)
...
roadsign = cv2.imread('D:\\Fall2016\\CS6600AI\\Projects\\roundabout3.png',0)
